...
#define _q2long(x, fb)		((int32_t)((x) >> (fb)))
 ...
 * 
 */
#define _qmul(x, y, xFb, yFb, resFb) ((fixedp)(((int64_t)(x) * (int64_t)(y)) >> ((xFb) + (yFb) - (resFb))))
 ...
 */
#define _qdiv(x, y, xFb, yFb, resFb) ((fixedp)((((int64_t)x) << ((xFb) + (yFb) - (resFb))) / y))
 ...
 */
#define _qinv(x, xFb, resFb) ((fixedp)((((int64_t)1) << (xFb + resFb)) / x))
